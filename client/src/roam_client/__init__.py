...
class Env:
    ...
    def func(self, fn: Callable[..., Any]) -> Any:
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            try:
                ...
                raise RuntimeError("Cannot call sync version from async context. Use 'await' instead.")
            except RuntimeError:
    ...
    async def _execute_remote(self, fn: Callable, *args, **kwargs) -> Any:
        ...
        try:
            ...
            raise RemoteExecutionError(f"HTTP error {e.response.status_code}: {e.response.text}")
